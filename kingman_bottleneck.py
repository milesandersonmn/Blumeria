...
def simulate_kingman_bottleneck(t_bottleneck, severity, duration,
                              N0,
...
def sim_summary_stats():
    ...
    while True:
        ...
        ts = simulate_kingman_bottleneck(t_bottleneck=t_b, severity=severity, duration=duration, N0=Ne,
                                         n_samples=sample_size, rate_map=rate_map, mu=mu)
